<template>
  <v-card class="mb-3 transparent__bg" dark outlined>
    <v-card-text>
      ...
      <v-list class="mt-1 trendingstocks__list">
        <v-list-item class="px-0">
          ...
          <v-list-item-content>
            <v-list-item-title class="caption"
              ><strong>Jollibee Foods Corporation</strong></v-list-item-title
            >
            <v-list-item-subtitle class="overline"
              >13 Hits</v-list-item-subtitle
            >
          </v-list-item-content>
        </v-list-item>
        <v-list-item class="px-0">
          ...
          <v-list-item-content>
            <v-list-item-title class="caption"
              ><strong>Nickel Asia Corporation</strong></v-list-item-title
            >
        ...
        <v-list-item class="px-0">
          ...
          <v-list-item-content>
            <v-list-item-title class="caption"
              ><strong>Philippine Infradev Housing</strong></v-list-item-title
            >
        ...
        <v-list-item class="px-0">
          ...
          <v-list-item-content>
            <v-list-item-title class="caption"
              ><strong>Vulcan Industrial & Mining</strong></v-list-item-title
            >
