      ...
      <v-container class="px-5">
        <v-row no-gutters>
          <v-col cols="12" sm="12" md="6">
            <v-card-title class="subtitle-1 pa-0 my-2 secondary--text">
              <span>Strategy</span>
            </v-card-title>
            <v-card-title class="subtitle-1 pa-0 my-2 secondary--text">
          ...
          <v-col cols="12" sm="12" md="6">
            <v-card-title class="subtitle-1 font-weight-bold pa-0 my-2 secondary--text">
          ...
          <v-col class="pa-2 mt-2 trading_notes" cols="12" sm="12" md="12">
            <v-card-title class="subtitle-2 pa-0 secondary--text">
              <span>Trading Notes</span>
            </v-card-title>
            <v-card-title class="caption pa-0 secondary--text notes_text">
