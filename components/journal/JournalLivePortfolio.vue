<template>
    <v-col class="pa-0">
        <v-card-title class="text-left justify-left px-0 py-3 pt-5">
            ...
            <v-btn rounded outlined color="#48FFD5" dark class="text-capitalize mr-2" style="border-width: 2px" height="23">Trade</v-btn>
            <v-btn rounded outlined color="#48FFD5" dark class="text-capitalize" style="border-width: 2px" height="23">Fund</v-btn>
        ...
        <!-- <v-card color="transparent" class="d-flex justify-end" elevation="0">
