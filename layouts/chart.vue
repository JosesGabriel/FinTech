<template>
  <v-app>
        ...
        <v-row no-gutters>
            ...
            <v-col v-bind:class="showSidebar">
                ...
                <v-row no-gutters>
                    <v-col class="col-12">
                        <v-slide-y-reverse-transition>
                            <v-content v-show="table" class="table__container" v-bind:class="{ maximize : maximize}">
                ...
                <div id="button_adjustview">
                    <v-btn @click="toggleTicker" color="pink" class="mr-1" dark>Ticker</v-btn>
                    <v-btn @click="toggleTable" color="orange" class="mr-1" dark>Table</v-btn>
                    <v-btn @click="maximizeTable" :disabled="!table"  color="orange" class="mr-1" dark fab small>
                        <v-icon>mdi-eject</v-icon>
                    </v-btn>
                    <!-- <v-btn @click="fullscreenTable" :disabled="!table" color="orange" class="mr-1" dark fab small>
                        <v-icon>mdi-fullscreen</v-icon>
                    </v-btn> -->
                    <v-btn @click="toggleSidebar" color="blue" dark>Sidebar</v-btn>
                </div>
            ...
            <v-slide-x-transition>
                <v-col v-show="sidebar" transition="slide-y-reverse-transition" class="sidebar__container col-3">
